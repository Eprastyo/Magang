...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url ('assets/docs/css/bootstrap.css')?>">
 	<script src="<?php echo base_url('assets/docs/js/jquery.js')?>"></script>
    <script src="<?php echo base_url('assets/docs/js/bootstrap.js')?>"></script>
</head>
<body>
   <div class="container">		
