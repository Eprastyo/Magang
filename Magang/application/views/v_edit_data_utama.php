...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
          ...
          <div class="card-mb">
              <div class="form-group">
                <div class="col-sm-5">
                  ...
                  <input type="text" name="no" value="<?php echo $u->no ?>" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-10">
                  <label for="usr">Nama PIC</label>
                  <input type="text" name="nama_pic" value="<?php echo $u->nama_pic ?>" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-10">
    ...
    <script src="<?php echo base_url('assets/docs/js/plugins/pace.min.js')?>"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="<?php echo base_url('assets/docs/js/plugins/chart.js')?>"></script>
