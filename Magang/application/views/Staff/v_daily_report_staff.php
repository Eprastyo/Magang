          ...
          <div class="table-responsive">
            <table id="example" class="table" style="width:100%;">
              ...
              <tr>
                ...
                <td>
                  <center>
                    <a href="update_progres_staff?nama_pic=<?php echo $hasil->nama_pic;?>&nama_project=<?php echo $hasil->nama_project?>&instansi=<?php echo $hasil->instansi?>">
                      <button class="btn btn-default" style="background-color: #7ed6df;">Update</button>
                    </a>
                    <a href="tampil_log_staff?nama_pic=<?php echo $hasil->nama_pic;?>&nama_project=<?php echo $hasil->nama_project?>&instansi=<?php echo $hasil->instansi?>">
                      <button class="btn btn-default" style="background-color: #badc58;">Detail</button>
                    </a>
                  </center>
                </td>
              </tr>
