<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-table"></i>Edit Staff</h1>
        </div>
      ...
      <div class="row">
        <div class="card-body">
           <?php foreach($t_data_staff as $u){ ?>
              <form action="<?php echo base_url(). 'Admin/update_staff'; ?>" method="post">
                <div class="card-mb">
                    <div class="form-group">
                      <div class="col-sm-5">
                        <label for="usr">ID User</label>
                        <input type="text" name="id_user" value="<?php echo $u->id_user ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-5">
