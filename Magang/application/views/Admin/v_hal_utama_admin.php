    ...
    <main class="app-content">
      ...
      <!--<label><b>TABEL JUMLAH CLIENT</b></label>
          ...
          <table class="table table-striped">
            <tr>
                <th width="30">Client Baru</th>
                <th>Client Existing</th>
                <th>Client Upgrade</th>
                <th>Client Downgrade</th>
            </tr>
            <tr>
                <td> 
                  <?php foreach ($jml_new->result() as $row) {
                    ?>
                    <p align="center"><b><?php echo $row->tot_new ?></b></p>
                  <?php
                    }
                  ?>
                </td>
                <td> 
                  <?php foreach ($jml_exist->result() as $row) {
                    ?>
                    <p align="center"><b><?php echo $row->tot_exist ?></b></p>
                    <?php
                    }
                    ?>
                </td>
                <td> 
                  <?php foreach ($jml_up->result() as $row) {
                    ?>
                    <p align="center"><b><?php echo $row->tot_up ?></b></p>
                  <?php
                    }
                  ?>
                </td>
                <td>
                  <?php foreach ($jml_down->result() as $row) {
                    ?>
                    <p align="center"><b><?php echo $row->tot_down ?></b></p>
                  <?php
                    }
                  ?>
                </td>
